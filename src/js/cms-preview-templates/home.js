    ...
    return <div>
        ...
        <div className="bg-grey-1 pv4">
          <div className="flex-l mhn1-l ph3 center mw7">
            ...
            <img class="" src={getAsset(product.get("image"))} width="220" height="220"></img>
          </div>
        </div>
        ...
        <div className="bg-grey-1 pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="flex-l mhn2-l">
              <div className="w-40-l ph2-l">
                <h2 className="f2 b lh-title mb2">{entry.getIn(["data", "testvalues", "heading"])}</h2>

                <p>{entry.getIn(["data", "testvalues", "text"])}</p>
              </div>
