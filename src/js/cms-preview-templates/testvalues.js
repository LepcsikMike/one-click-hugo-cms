...
export default class TestValuesPreview extends React.Component {
  render() {
    ...
    const entryTestValues = entry.getIn(["data", "testvalues"]);
    const testvalues = entryTestValues ? entryTestValues.toJS() : [];
    
    return <div>
      <Jumbotron image={image} title={entry.getIn(["data", "title"])} />
      <div className="bg-off-white pv4">
        <div className="mw7 center ph3 pt4">
          {testvalues.map(({text, heading, imageUrl}, i) =>
